...
The model has 1.3M trainable parametersl to achieve an accuracy of 72%. The model is initially trained for 350 epochs on a batch size of 512 and for the Active Learning step a batch size of 512 and 600 epochs. The first training loop the model achieves 73% accuracy and the second training loop after the active learning step it achieves.
